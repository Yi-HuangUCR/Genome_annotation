...
#SBATCH --time=00-02:00:00     # 7 day
#SBATCH --output=maker_round2.stdout
...
mpirun maker -fix_nucleotides -base glauca_rnd2 -f maker_bopts.ctl maker_exe.ctl maker_opts_rnd2.ctl 
